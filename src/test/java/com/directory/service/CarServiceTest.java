...
class CarServiceTest {
    ...
    void filterByBrand() {
        ...
        // when
        boolean isFind = underTestCarService.filterByBrand("TestBrand").contains(carTest);
        carRepository.delete(carTest);
    ...
    void filterByColor() {
        ...
        // when
        boolean isFind = underTestCarService.filterByColor("TestColor").contains(carTest);
        carRepository.delete(carTest);
    ...
    void addCar() {
        // given
        Car carTest = new Car("TestNumber", "TestBrand", "TestColor");
        underTestCarService.addCar(carTest);
    ...
    void delete() {
        ...
        // when
        underTestCarService.deleteCar(carTest.getId());
